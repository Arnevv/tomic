...
EXTRA_PATTERNS = {
    ...
    "term_m1_m2": [
        r"M1\s*[\-\u2013]\s*M2[^0-9-]*(-?[0-9]+(?:\.[0-9]+)?)%?",
        r"Term\s*M1\s*[\-\u2013]\s*M2[^0-9-]*(-?[0-9]+(?:\.[0-9]+)?)%?",
        r"M1\s*[\-\u2013]\s*M2:</span>\s*</span>\s*<span><strong>(-?[0-9]+(?:\.[0-9]+)?)%",
    ],
    "term_m1_m3": [
        r"M1\s*[\-\u2013]\s*M3[^0-9-]*(-?[0-9]+(?:\.[0-9]+)?)%?",
        r"Term\s*M1\s*[\-\u2013]\s*M3[^0-9-]*(-?[0-9]+(?:\.[0-9]+)?)%?",
        r"M1\s*[\-\u2013]\s*M3:</span>\s*</span>\s*<span><strong>(-?[0-9]+(?:\.[0-9]+)?)%",
    ],
}
