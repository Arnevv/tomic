...
def test_generate_strategy_candidates_with_strings():
    chain = [
        {"expiry": "20250101", "strike": "110", "type": "C", "bid": "1", "ask": "1.2", "delta": "0.4"},
        {"expiry": "20250101", "strike": "120", "type": "C", "bid": "0.5", "ask": "0.7", "delta": "0.2"},
        {"expiry": "20250101", "strike": "90", "type": "P", "bid": "1.0", "ask": "1.1", "delta": "-0.3"},
        {"expiry": "20250101", "strike": "80", "type": "P", "bid": "0.4", "ask": "0.6", "delta": "-0.1"},
    ]
    cfg = {
        "strategies": {
            "iron_condor": {
