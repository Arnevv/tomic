...
def test_exit_flow_cli_runs(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(cli_mod, "build_exit_intents", lambda positions_file=None, journal_file=None: [intent])
...
def test_exit_flow_cli_symbol_filter(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(cli_mod, "setup_logging", lambda: None)
    monkeypatch.setattr(cli_mod, "build_exit_intents", lambda positions_file=None, journal_file=None: intents)
