...
def make_chain_csv(path: Path) -> None:
    rows = [
        ...
        ["20250101", "C", "100", "1", "1.2", "0.2", "0.4", "0.1", "0.2", "-0.05", "10", ""],
        ["20250101", "C", "105", "0.5", "0.7", "0.18", "0.3", "0.08", "0.15", "-0.04", "5", ""],
        ["20250101", "P", "95", "0.6", "0.8", "0.22", "-0.3", "0.09", "0.18", "-0.06", "8", ""],
        ["20250101", "P", "90", "0.4", "0.6", "0.25", "-0.2", "0.07", "0.16", "-0.05", "7", ""],
    ]
